                ...
                <div className="about-content ms-0 style-about">
                  <div className="section-title">
                    <span className="sub-content wow fadeInUp">
                      ...
                      About Keystone Strategic Consultants LLC
                    </span>
                  ...
                  <p className="mt-3 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                    At Keystone Strategic Consultants LLC, we are more than advisors — we are partners in your business journey. Our mission is to help organizations overcome complex challenges, transform operations, and achieve measurable, sustainable growth.
                  </p>
                  <div className="icon-items wow fadeInUp" data-wow-delay=".3s">
                    ...
                    <div className="content">
                      ...
                      <p>
                        Every engagement we undertake is driven by integrity, precision, and excellence. We go beyond reports and recommendations — we ensure strategies are executed effectively, creating long-term value for our clients.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-lg-6">
                <div className="about-content">
                  ...
                  <p className="mt-3 wow fadeInUp" data-wow-delay=".5s">
                    We understand that every business has unique needs. Our consulting approach is designed for flexibility — whether you require project-based strategy, long-term transformation, or on-demand advisory support, we scale our services to fit your vision.
                  </p>
                  <div className="icon-items wow fadeInUp" data-wow-delay=".3s">
                    <div className="dot" />
                    <div className="content">
